...
assert.ok(
  vmtJs.startsWith("/* Generated by data/slurp.py from the in-repo VMT master data/vmt.csv."),
  `Replicata: inspect the top of data/vmt.js.
Expectata: the generated VMT artifact declares that data/slurp.py built it from the in-repo VMT master.
