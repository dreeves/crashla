/* Generated by data/slurp.py from the in-repo VMT master data/vmt.csv. See data/README.md. */
const VMT_CSV_TEXT = /* VMT_CSV_START */
`helmer,month,vmt,helmer_cumulative_vmt,vmt_min,vmt_max,coverage,incident_coverage,incident_coverage_min,incident_coverage_max,rationale
tesla,2025-06,683,683,614,751,1.0,1,1,1,Austin only: robotaxitracker end-of-month cumulative delta; tracker anchors to Tesla fleet-wide disclosures so highway rides with driver-seat monitor (Sep 2025+) are included — matching the incident scope (None + In-Vehicle Commercial/Test).
tesla,2025-07,6317,7000,4781,7854,1.0,1,1,1,Austin only: robotaxitracker end-of-month cumulative delta; tracker anchors to Tesla fleet-wide disclosures so highway rides with driver-seat monitor (Sep 2025+) are included — matching the incident scope (None + In-Vehicle Commercial/Test).
tesla,2025-08,69498,76498,59073,79922,1.0,1,1,1,Austin only: robotaxitracker end-of-month cumulative delta; tracker anchors to Tesla fleet-wide disclosures so highway rides with driver-seat monitor (Sep 2025+) are included — matching the incident scope (None + In-Vehicle Commercial/Test).
tesla,2025-09,91918,168416,90235,93602,1.0,1,1,1,Austin only: robotaxitracker end-of-month cumulative delta; tracker anchors to Tesla fleet-wide disclosures so highway rides with driver-seat monitor (Sep 2025+) are included — matching the incident scope (None + In-Vehicle Commercial/Test).
tesla,2025-10,81584,250000,69258,93910,1.0,1,1,1,Austin only: robotaxitracker end-of-month cumulative delta; tracker anchors to Tesla fleet-wide disclosures so highway rides with driver-seat monitor (Sep 2025+) are included — matching the incident scope (None + In-Vehicle Commercial/Test).
tesla,2025-11,165636,415636,140790,190481,1.0,1,1,1,Austin only: robotaxitracker end-of-month cumulative delta; tracker anchors to Tesla fleet-wide disclosures so highway rides with driver-seat monitor (Sep 2025+) are included — matching the incident scope (None + In-Vehicle Commercial/Test).
tesla,2025-12,234364,650000,177685,291043,1.0,1,1,1,Austin only: robotaxitracker end-of-month cumulative delta; tracker anchors to Tesla fleet-wide disclosures so highway rides with driver-seat monitor (Sep 2025+) are included — matching the incident scope (None + In-Vehicle Commercial/Test).
tesla,2026-01,263047,913047,147907,378186,1.0,1,1,1,Austin only: robotaxitracker end-of-month cumulative delta; tracker anchors to Tesla fleet-wide disclosures so highway rides with driver-seat monitor (Sep 2025+) are included — matching the incident scope (None + In-Vehicle Commercial/Test).
...
waymo,2026-01,16600000,189084810,12450000,20750000,1.0,1,1,1,"US est.: anchored to 200M cumulative milestone (crossed between Feb 6 and Feb 23, 2026 per Waymo posts) and co-CEO's >4M rider-only mi/week at ~500k paid trips/week (late Mar 2026); ±25%"
...
waymo,2026-02,15600000,204684810,11700000,19500000,1.0,1,1,1,"US est.: anchored to 200M cumulative milestone (crossed between Feb 6 and Feb 23, 2026 per Waymo posts) and co-CEO's >4M rider-only mi/week at ~500k paid trips/week (late Mar 2026); ±25%"
