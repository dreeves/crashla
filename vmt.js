...
tesla,2025-06,1806,1806,1806,1806,0.533,1,1,1,Austin only: robotaxitracker end-of-month cumulative delta; assume already netted to empty driver-seat miles.
...
waymo,2025-06,7055803,7055803,5997433,8114173,0.533,1,1,1,US est.: scale CA driverless VMT incl deadhead to all US using Waymo RO-mile city shares (through Sep 2025); ±15%.
...
waymo,2026-01,28509017,127701806,19956312,37061722,0.484,0.5113,0.32,0.6136,US est.: extrapolate beyond Sep 2025 then scale to all US; -30%/+30%.
zoox,2025-06,120000,120000,60000,240000,0.533,1,1,1,US rough est.: no month-level public VMT series; placeholder based on limited public ops; 0.5x–2x band.
...
zoox,2026-01,220000,1345000,110000,440000,0.484,0.3333,0.3333,0.3333,US rough est.: no month-level public VMT series; placeholder based on limited public ops; 0.5x–2x band.
`
/* VMT_CSV_END */;
