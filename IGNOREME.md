...
- Jargon: the code calls the entity at the wheel a "helmer" (Tesla, Waymo, Zoox, or one of three human benchmark cohorts); the user-facing label is "Company" (the "helmsbeing" coinage never reached the UI).
...
- Tesla mileage is anchored to Tesla's own disclosures: the "Cumulative Paid Robotaxi Miles" chart in the quarterly update decks, with monthly values vector-extracted from the Q4-2025, Q1-2026, and Q2-2026 deck PDFs (the decks' overlapping months agree within ~8k miles; 658k end-2025, 1.717M end-Mar-2026, 2.440M end-Jun-2026). Beyond the last deck anchor, months are placeholders re-pinned each earnings quarter: the Jul–Sep 2026 rows rest on Tesla's Sep-3-2026 statement of "1 million miles of unsupervised Robotaxi operation" (the unsupervised subset, a lower bound on service miles, up from ">380,000" on Jul 22) with bands from the deck series' own month-to-month volatility; the trackers no longer publish a mileage model (robotaxitracker.com dropped its own in Aug 2026), and fleet-count methods were retired after they over-predicted Q2 1.4–2.9x. Dallas/Houston service (unsupervised launch Apr 18, 2026) is included from 2026-04 onward; the Bay Area is excluded — Tesla itself tracks it as a separate supervised series (Q3-2025 call: Bay Area has "crossed more than a million miles" with a driver-seat safety driver, vs the Austin fleet's "more than a quarter million"), outside the SGO driverless scope. The disclosed series reads as fleet service miles including deadhead — the same figures are described on the Q3-2025 call as miles the fleet has "covered", and the trackers' ~115 mi/vehicle/day model equates them to fleet-wide miles — but if "paid" is literally passenger-on-board miles the true denominator is higher, so the cumulative band carries one-directional upside (~15%). Scope note (resolved 2026-06-12): the disclosures are fleet-wide with no breakdown by monitor seating, so the denominator includes the post-Sep-2025 highway rides with the safety monitor in the driver's seat — which matches the incident numerator (Driver/Operator Type "None" plus Tesla's "In-Vehicle (Commercial / Test)" and "Remote (Commercial / Test)"). (Historical: until 2026-07-22 the rows were tracker-interpolated between sparse verbal anchors, which left Aug-Sep 2025 ~3.8x high and end-Q1-2026 9% low vs the deck chart.)
- Waymo VMT is estimated by scaling [California CPUC driverless VMT](https://www.cpuc.ca.gov/regulatory-services/licensing/transportation-licensing-and-analysis-branch/autonomous-vehicle-programs/quarterly-reporting) (including deadhead) to all US cities using Waymo cumulative milestones. For Jul 2024 through Sep 2025 the error band is +/-25%; Oct-Dec 2025 use +/-30%; Jan-Mar 2026 are calibrated to Waymo's 220.6M-rider-only-mile cumulative through March 2026 (Safety Impact update, Jun 24, 2026) minus D 1.79M (Atlanta miles the hub appears to count twice; see the anchor table in data/README.md) plus an explicit +2.0M [1.2M, 3.3M] for metros the hub had not yet benchmarked (Miami, Dallas, Houston, San Antonio, Orlando, Nashville — the hub total counts benchmarked locations only), bridging from the 170.7M − 1.17M + 3.7M end-Dec-2025 anchor, with +/-25% bands; Apr–Jun 2026 are built bottom-up on the hub's MEASURED Q2 (Sep 24, 2026 update, 271.3M through June; re-chained 2026-09-25): CPUC CA actuals × 1.058 (the hub's CA counties run 4-6% above CPUC; ±3%) + the hub's measured Maricopa/Travis increments (±10%) + Atlanta counting each double-listed cell once (the published figure sets the upper edge) + the excluded-metro estimate, about −9%/+14%; Jul–Sep 2026 extend that construction at about −20%/+27%. (Earlier months have wider bands; see the Waymo VMT Methodology section below.) Domestic-scope caveat: every anchor to date is US-only (the per-city breakdowns list only US cities), matching the US-only NHTSA SGO numerator — but Waymo began London operations in Apr 2026, so before recalibrating against any future cumulative-miles anchor, verify it hasn't started folding in international miles.
- Zoox VMT estimates draw on [CPUC quarterly reports](https://www.cpuc.ca.gov/regulatory-services/licensing/transportation-licensing-and-analysis-branch/autonomous-vehicle-programs/quarterly-reporting) (California-only paid miles) and [Las Vegas operations](https://techcrunch.com/2025/09/10/zoox-opens-its-las-vegas-robotaxi-service-to-the-public/), with the cumulative series anchored to three company milestones — 1.3M driverless public-road miles as of Dec 31, 2025 (Zoox's own letter to NHTSA, Jan 28, 2026, docket NHTSA-2025-0523-0004 p.22, superseding the earlier ~1M-late-2025 press floor), ~2M by late March 2026 (>350k riders), and >3M stated Aug 5, 2026, the middle one corroborated across multiple outlets ([Electrek](https://electrek.co/2026/03/09/zoox-expands-robotaxi-testing-phoenix-dallas-autonomous/), [The Robot Report](https://www.therobotreport.com/zoox-sets-geographic-milestones-product-features-robotaxi/)). Error bands were tightened from 0.5x-2x to 0.7x-1.3x (Jun 2026) now that those milestones bracket the series; the residual band reflects monthly-allocation uncertainty, scope ambiguity (company "autonomous miles" vs the NHTSA SGO public-road driverless scope), and milestone rounding. California DMV 2025 testing miles (~1.2M, mostly drivered) are out of scope and excluded.
...
- The credible interval combines uncertainty from incident counts (Gamma-Poisson) and from VMT by marginalizing the posterior over a two-piece (split) log-normal VMT prior with its mode at vmt and exactly 95% of its mass inside [vmt_min, vmt_max] (tail mass split in proportion to the side sigmas; degenerates to the symmetric log-normal when the band is log-symmetric — see splitPriorSigmas in crashla.js): the displayed lo/hi are the exact 2.5%/97.5% quantiles of that marginal — the same distribution the probability-distribution chart draws. (Until 2026-08-21 the bounds were instead a conservative worst-case pairing — vmt_min with the upper lambda quantile and vice versa — which held 97.9-99.4% of the posterior rather than 95%.)
- The VMT data carries a receipt-coverage triple (`coverage`, `coverage_min`, `coverage_max`) for the NHTSA data-through month — the release holds reports received through the 15th of the prior month, rolled forward to the next business day (August 17, 2026 for the Sep-15 file), which cover only the first ~third of that month's five-day-track crashes. The triple is measured from snapshot history (best 0.28, band 0.20–0.52), not a fraction of days; every earlier month is 1.0, June 2025 included. The Monthly-track metrics additionally apply the pooled incident-coverage factor for that month, because their NHTSA filings are not due until the 15th of the following month; the five-day-track metrics (fatality, hospitalization, airbag) use the receipt-scaled VMT alone (see the "incident coverage" sanity check on the page).
...
Human baselines are shown as shaded bands (range of plausible values) rather than single lines, and since 2026-06-11 come in three cohorts displayed as separate "helmers" (two shades of gold, plus orange for the default-off **Humans (Uber/Lyft)** proxy — the rider's alternative: the sourced Uber/Lyft fatality rate, and elsewhere a band derived from the AV-cities one): **Humans (AV cities)** — the bands described below, surface streets in AV operating areas — and **Humans (US average)** — nationwide CRSS/FARS crashed-vehicle rates across all road types, Blincoe-adjusted at the low end. The US-average cohort's hospitalization, airbag, and serious-injury bands are wide log-interpolations between the national injury and fatality anchors (no direct national per-mile rates exist for those), and the stress test plus the "Nx vs humans" card multipliers compare against the AV-cities cohort, the more apples-to-apples baseline. For injury, airbag, and serious-injury+, the AV-cities bands are set directly from [the live Waymo Safety Impact hub's per-city benchmarks](https://waymo.com/safety/impact/) (five areas, data through Jun 2026 as of the Sep 24, 2026 hub update; superseding [Kusano & Scanlon's 56.7M-mile paper](https://arxiv.org/abs/2505.01515)) (the surface-street human rates Waymo/Piper cite): each spans the per-city range (Phoenix-to-SF for injury and serious+, LA-to-Atlanta for airbag) with its geometric center — the value the "Nx vs humans" cards divide by — near the mileage-blended value (any-injury 3.77, airbag 1.62, serious+ 0.213 IPMM; the centers sit 5% below it for injury and serious+ and 17% above it for airbag, whose high-rate edge is Atlanta), so for these three the cohort tracks the location-weighted benchmark rather than estimating it independently. The all-crashes band remains our own synthesis of [Kusano & Scanlon (2024)](https://arxiv.org/abs/2312.12675) observed-to-Blincoe-adjusted rates (surface streets, passenger vehicles, underreporting-corrected; see also [this analysis](https://www.theargumentmag.com/p/we-absolutely-do-know-that-waymos)). We still don't reproduce Waymo's full pipeline (its dynamic intra-city weighting and exact outcome definitions), and [Waymo's own safety page](https://waymo.com/safety/impact/) concurs with these anchors. Note also that the app's default metric (fault-weighted "at-fault" incidents, any severity, as of 2026-06-12) is broader than Waymo's surface-street, injury-focused framing — it includes minor property-damage contacts that injury-based comparisons exclude, which is why its human band's low anchor collapses to the all-crash low anchor (see the at-fault derivation note in `crashla.js`).

- **Band interpretation:** For injury/airbag/serious-injury+, the band spans the hub's per-city human-rate range (the highest-rate city at the low-MPI end — SF for injury/serious+, Atlanta for airbag — and the lowest-rate city at the high-MPI end), with its geometric center near the mileage-blended value — it reflects how much the comparable human rate varies by where Waymo drives. For all-crashes, the band spans observed-to-Blincoe-adjusted rates (the ~60%-minor-crash underreporting range). The true apples-to-apples MPI should fall within each band.
- **Scope by cohort and metric:** the AV-cities crash-frequency benchmarks (all / injury / airbag / serious-injury+) are surface-street rates in AV operating areas (higher crash rates than the national average), following the Kusano/Scanlon and Waymo-hub approach; the AV-cities fatality band is all urban roads (freeway-inclusive, matching the AV side's all-roads scope); the US-average cohort is nationwide, all road types.
...
2. **Miles are compatible — and now confirmed well past 200M.** Piper said "over 200 million" for Waymo total; that milestone was confirmed Feb 23, 2026 (https://www.benzinga.com/markets/tech/26/03/50953948), and Waymo's Safety Impact updates report 220.6M rider-only miles through end of March 2026 (Jun 24, 2026; per-city: Phoenix 80.6M, SF Bay 67.1M, LA 51.8M, Austin 15.8M, Atlanta 5.4M) and 271.3M through end of June 2026 (Sep 24, 2026; Phoenix 92.1M, SF Bay 82.4M, LA 67.1M, Austin 21.1M, Atlanta 8.6M). Earlier snapshots: 127M through Sep 2025, 170.7M through Dec 2025. Waymo defines "rider-only miles" as miles without a human driver in cities where it operates; we treat that as including deadhead and overhead, matching the CPUC `TotalVMTZEV` definition — an assumption our VMT estimates depend on but that the Waymo page alone does not establish. Our Waymo VMT series is anchored to land on hub − D + E by construction: 220.6M − 1.79M + 2.0M − 0.15M = 220.67M through Mar 2026 and 271.3M − 2.84M + 6.65M − 0.15M = 274.99M through Jun 2026 (the hub counts only benchmarked metros, so E adds the estimate for Miami, Dallas, Houston, San Antonio, Orlando and Nashville; D removes the Atlanta miles the hub appears to double-count; the 0.15M is the pre-series slice — see the anchor table and notes in data/README.md). Before the Mar-2026 recalibration the series estimated 225.2M (~2% high), confirming the methodology was well-calibrated.
...
4. **Fault attribution.** Piper doesn't discuss who's at fault. Our AI fault-fraction analysis shows most of Waymo's incidents (1,981 full-history as of the 2026-08-17 fetch) were caused by other drivers. Fault-weighting makes Waymo look even safer than the raw incident count suggests.
...
coverage=1.0 in the VMT data means "VMT and incidents are already aligned" — no pro-rating needed; only the NHTSA data-through month carries a smaller (measured) receipt-coverage value.
...
For the data-through month (reports received through the 15th of the prior month, or the next business day), receipt coverage scales every metric's VMT to the ~third of the month's five-day-track crashes that a first release actually contains, and the Monthly-track metrics are additionally thinned by the pooled incident-coverage factor because their filings are not due until the following month (see the "Incident coverage for partial months" sanity check on the page). The cutoff itself is a reviewed constant in `data/slurp.py` guarded by content asserts; it is not inferred from the file's modification date, which runs a month later.
...
2. **Vehicle Miles Traveled (VMT)** (the denominator).
   ...
   - **Tesla**: Tesla's own quarterly-deck "Cumulative Paid Robotaxi Miles" chart, monthly values vector-extracted from the deck PDFs (Texas service: Austin, plus Dallas/Houston from their Apr 2026 unsupervised launch; Bay Area excluded — Tesla tracks it as a separate supervised series, outside the public-service scope); months past the last deck anchor are placeholders pinned to Tesla's latest public mileage statement (Sep 3, 2026: 1M unsupervised miles) with deck-volatility bands, re-pinned at the next deck.
   - **Waymo**: See "Waymo VMT Methodology" section below.
   - **Zoox**: US estimates anchored to three company milestones (1.3M driverless public-road miles as of Dec 31, 2025 — Zoox's letter to NHTSA, docket NHTSA-2025-0523-0004; ~2M by late March 2026; >3M stated Aug 5, 2026; 0.7×–1.3× error band), with monthly detail interpolated from California CPUC and Las Vegas operations. California DMV testing miles are out of scope.
...
2. **Waymo cumulative US milestones** (for CA→US scaling):
   ...
   | End Mar 2025 | 71.43M + 0.19M | Waymo Safety Hub CSV1 (Jun 12, 2025 release; Atlanta 0.056M and Mountain View 0.132M listed but excluded from the blended total) |
   | End Jun 2025 | 95.97M + E 0.7M [0.4, 1.3] | Waymo Safety Hub CSV1 (PHX/SF/LA/ATX; Atlanta and Santa Clara not counted) |
   | End Sep 2025 | 127.16M + E 2.0M [1.3, 3.1] | Waymo Safety Hub geographic breakdown (Atlanta and Santa Clara not counted) |
   | End Dec 2025 | 170.71M + E 3.7M [3.0, 4.6] | Waymo Safety Impact (Mar 19, 2026 release; county basis, Santa Clara newly counted; Atlanta ~3.5M, Miami and the four Dec-2025 metros not counted) |
   | ~Feb 14, 2026 | ~200M | Waymo X post ("nearly 200M" Feb 6; "over 200M" Feb 23) |
   | End Mar 2026 | 220.61M − D 1.79M + E 2.0M [1.2, 3.3] | Waymo Safety Impact update (Jun 24, 2026); per-city PHX 80.6M / SF 67.1M / LA 51.8M / ATX 15.8M / ATL 5.4M (Atlanta now counted, whole); Miami-Dade, Dallas, Harris, Bexar, Orange, Davidson not counted |
   | End Jun 2026 | 271.33M − D 2.84M + E 6.65M [4.0, 10.2] | Waymo Safety Impact update (Sep 24, 2026); per-city PHX 92.1M / SF Bay 82.4M / LA 67.1M / ATX 21.1M / ATL 8.6M; same eight counties, so the same metros stay in E |
   ...
   Note (2026-08-28): a hub "All Locations" total counts benchmarked locations only (release notes, Jun 12, 2025). E is the explicit estimate of rider-only miles in the then-unbenchmarked metros — the repo's incident numerator already contains those metros' crashes, so leaving E out would mismatch numerator and denominator. Before this, the 170.7M→220.6M step had absorbed Atlanta's whole 2025 history as Q1-2026 growth (partly offset by the new-metro exclusion), and the 127M→170.7M step ~1-2M of Santa Clara's. The E table with sources lives in data/README.md and is pinned by quals/waymo-vmt-provenance.qual.

   Note (2026-09-25): D is the Atlanta mileage the hub appears to count twice. Its per-cell detail file (CSV4) lists ~85 Fulton/DeKalb S2 cells twice with identical miles, and its county totals count both copies (Atlanta 8.62M thru Jun 2026 vs 5.78M counting each cell once). The best estimate treats the copies as an error; the band's upper edge keeps the published total. Earlier anchors carried Atlanta inside E (estimated from the published Mar-2026 figure), so the same one-third correction applies there too (0.21M Jun 2025, 0.47M Sep 2025, 1.17M Dec 2025). Details and the recipe: data/README.md, Waymo anchors.

   Note: every published figure above (plus E and minus D where shown) is pinned as an exact *central* estimate, minus ~0.15M pre-series miles (driverless miles before the series' Jul-2021 SGO start), with the `kyoom_min`/`kyoom_max` band expressing the milestone's rounding/timing uncertainty. Historical note: through Jul 2026 these figures were instead encoded as lower-bound *floors* with the best-estimate cumulative running a constant ~2.8M above them — a level offset seeded by an early-ramp interpolation that overshot the ~1M-Jan-2023 milestone ~4x. The re-baseline (Jul 2026) subtracted that constant, which landed every milestone month at exactly (published − 0.15M) — confirming the CPUC-scaled monthly *profile* had been well-calibrated all along — and raised the default-window (Jun-2025+) Waymo VMT ~1.7%, since the old offset was absorbed back to zero by the exact Dec-2025 pin inside the window. quals/waymo-vmt-provenance.qual pins all of these milestones.
...
| Oct–Dec 2025 | ~56% | CPUC Q4-2025 actuals (24.74M CA) vs the anchor-bridged 44.56M US |
| Jan–Mar 2026 | ~56% | CPUC Q1-2026 actuals (26.45M CA incl. pilot) vs the anchor-bridged 47.58M US; Austin/Atlanta expansion |
...
All authored `vmt_min`/`vmt_max` bands — whatever the ±X% shorthand in a row's rationale — are read by the app as the **exact 95% interval** (mode at `vmt`) of the two-piece log-normal VMT prior, per the S1 decision of 2026-08-21 (see splitPriorSigmas in crashla.js and the Statistical Method bullet above). So "±30%" means "the 95% band was authored at ±30%", not a hard bound or a 1-sigma band.
...
- **Oct–Dec 2025** (±30%): Bridges Waymo's published cumulative anchors — 127.16M − D 0.47M + E 2.0M end-Sep to the 170.71M − D 1.17M + E 3.7M end-Dec 2025 pin (hub figure, minus the Atlanta D, plus excluded-metro E; re-chained 2026-08-28 and D-corrected 2026-09-25, monthly shape unchanged), both minus the ~0.15M pre-series slice (the CPUC-shaped monthly profile ×1.103 after the 2026-08-28 re-chain, less D's monthly increments); CPUC CA VMT plateaued at ~8.4M/month (Q4-2025 actuals: Oct 7.90M, Nov 8.41M, Dec 8.42M) while US VMT grew modestly as Austin expanded; implied average CA share 55.5% (24.74M CA / 44.56M US).
- **Jan–Mar 2026** (±25%): Anchored to Waymo's 220.61M rider-only miles through March 2026 (Safety Impact update, Jun 24, 2026) minus D 1.79M plus E 2.0M for the still-unbenchmarked metros, bridging from the 170.71M − 1.17M + 3.7M end-Dec-2025 anchor (re-chained 2026-08-28: the raw 170.7→220.6 step included Atlanta's entire 5.4M history, so the pre-rebuild Q1 rows ran ~3% high; D-corrected 2026-09-25); the implied ~16.7M March (~3.9M/week) sits just under the co-CEO's >4M rider-only miles/week at ~500k paid trips/week (late Mar 2026). The lower band at March (219.87M) sits at the confirmed 220M milestone less the ~0.15M pre-series slice. Out-of-sample check (2026-07-24): CPUC Q1-2026 actuals (CA driverless 9.09M/8.19M/9.11M Jan/Feb/Mar, deployment + ~20k/mo pilot) match this series' monthly shape within ~4% (CA share 55.6% against the re-chained rows).
- **Apr–Jun 2026** (≈ −9%/+14%): Built bottom-up on the hub's measured Q2 (Sep 24, 2026 update; re-chained 2026-09-25): CPUC Q2-2026 CA driverless actuals (posted Aug 18, 2026; deployment + pilot, TotalVMTZEV) × 1.058, the ratio of the hub's four CA counties to CPUC in Q2 (1.040 in Q1; ±3%) + the hub's measured Q2 increments for Maricopa (11.57M) and Travis (5.28M) split by the prior monthly shape (±10%) + Atlanta counting each double-listed S2 cell once (2.20M; the published 3.25M sets the upper edge) + the excluded-metro estimate (1.4M/1.45M/1.8M; ±40-50%). Rows: 17.69 / 18.17 / 18.45M (the 2026-08-28 build had 17.4 / 17.85 / 18.1M on Q1 run-rates; the pre-rebuild rows, 19.0/20.5/20.5M, had assumed the CA share falling to ~47-50%). Cross-check: June ≈ 4.3M mi/wk vs Waymo's Jun 24, 2026 "more than 4 million miles every week". Jun held ~flat for the May-21-to-end-June US freeway-ride suspension. **Jul–Sep 2026** (≈ −20%/+27%): same construction extended (CA on the CPUC basis ±10-15%, × 1.058 [1.040, 1.076]; Maricopa/Travis/Atlanta ±25%; the excluded metros grow to 2.0/2.3/2.85M as Dallas opened to all Aug 4, Houston Aug 20, Denver/San Diego/Tampa Sep 1, Las Vegas Sep 14, and San Antonio resumed Sep 17): 19.07 / 20.32 / 21.07M. Freeway rides resumed Jul 29 from Phoenix, LA/SF Bay ~first week of Aug, Austin Sep 22; Ojai open to all riders Aug 19-20. To be re-pinned from CPUC Q3 (~mid-Nov) and the hub update with data through Sep 2026 (~mid/late Dec).
