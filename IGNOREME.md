...
- **Oct–Dec 2025** (±30%): Bridges Waymo's published cumulative anchors — 127M end-Sep to the 170.7M end-Dec 2025 pin, both minus the ~0.15M pre-series slice (the CPUC-shaped monthly profile ×1.0653, since the pre-re-baseline series had absorbed its level offset across this interval); CPUC CA VMT plateaued at ~8.4M/month (Q4-2025 actuals: Oct 7.90M, Nov 8.41M, Dec 8.42M) while US VMT grew modestly as Austin expanded; implied average CA share 56.4% (24.74M CA / 43.85M US).
...
- **Apr–Jun 2026** (±15-16%): Extrapolated from the 220.6M end-Mar-2026 anchor, then tightened by CPUC Q2-2026 CA driverless actuals (posted Aug 18, 2026; deployment + pilot, TotalVMTZEV) covering ~47-50% of each month's estimate, with ±30% on the non-CA remainder only; Jun held ~flat vs May for the May-21-to-end-June US freeway-ride suspension. **Jul 2026** (±30%): extrapolated; freeway rides resumed Jul 29 from Phoenix.
